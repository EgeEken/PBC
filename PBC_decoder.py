...
# |------------------------------------------------------------------------------|
# | This is the V1.0 Decoder for the Probabilistic Brush Compression algorithm.  |
...
def main():
    ...
    filename = input("Enter the compressed binary filename: ")
    
    img = recreate_from_file(filename)
    Image.fromarray(img).save(filename + "_recreated.png")
